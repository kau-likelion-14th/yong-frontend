    ...
    <footer className="footer-fixed">
      ...
      <div className="footer-bottom-info">
        ...
        <div className="business-info-grid">
          ...
          <div className="info-item address">주소: 경기도 고양시 항공대학로 76 항공우주센터 3층 창업카페</div>
          <div className="info-item empty"></div> {/* 4열을 맞추기 위한 빈 칸 */}

          <div className="info-item">사업자 등록번호: 333-22-55555</div>
